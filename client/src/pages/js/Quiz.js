...
export default class Register extends Component {
  ...
  render() {
    ...
    //quiz instruction 1
    final.push( <div>
        <label className="quizinstr">When you decide whether something is right or wrong,
        to what extent are the following considerations relevant to your thinking?
        Please rate each statement using this scale. 0 = Not at all relevant.
        1 = Not very relevant. 2 = Slightly relevant. 3 = Somewhat relevant. 4 = Very relevant.
        5 = Extremely relevant.</label>
    </div>)
    ...
    //quiz instruction 2
    final.push( <div>
        <label className="quizinstr">Please read the following sentences and indicate your 
        agreement or disagreement. 0 = Strongly disagree. 1 = Moderately disagree. 2 = Slightly disagree.
        4 = Moderately disagree. 5 = Strongly agree.</label>
    </div>)
...
var json = ['{"question":"Whether or not someone suffered emotionally."}',
